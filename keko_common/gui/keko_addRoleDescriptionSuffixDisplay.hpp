class keko_addRoleDescriptionSuffixDisplay
{
	idd = 90001;
	movingEnable = true;
	class Controls
	{
		...
		class RadiusValue: keko_RscEdit
		{
			...
			w = 0.18375 * safezoneW;
			h = 0.028 * safezoneH;
			onLoad = "(_this select 0) ctrlSetText (profileNamespace getVariable ['keko_lastSuffix',''])";
		};
		...
		class Confirm: keko_RscButton
		{
			...
			w = 0.065625 * safezoneW;
			h = 0.028 * safezoneH;
			action = "call keko_common_fnc_addRoleDescriptionSuffix";
		};
	};
};