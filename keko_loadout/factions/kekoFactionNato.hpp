// define weapons
#include "NATO\kekoWeaponsNato.hpp"

class kekoFactionNato: kekoFaction {

	class kekoLeadNato;
	class kekoSQLNato;
	class kekoFTLNato;
	class kekoDoctorNato;
	class kekoMedicNato;
	class kekoRiflemanNato;
	class kekoRiflemanATNato;
	class kekoGrenadierNato;
	class kekoLMGNato;
	class kekoLMGAsstNato;
	class kekoMMGNato;
	class kekoMMGAsstNato;
	class kekoATSpecialistNato;
	class kekoATSpecialistAsstNato;
	class kekoAASpecialistNato;
	class kekoAASpecialistAsstNato;
	class kekoMarksmanNato;
	class kekoSniperNato;
	class kekoSpotterNato;
	class kekoEODNato;
	class kekoEngineerNato;
	class kekoPilotNato;
	class kekoJTACNato;
	class kekoUAVOperatorNato;
...
[2, "#PRIMARY_MAG_MMG"],[2, "#GRENADE"]
	...
	class kekoATSpecialistNato: kekoSoldierNato {
		...
		launcherWeapon[] = {keko_W_TITAN_AT};
	};
	...
	class kekoAASpecialistNato: kekoSoldierLightNato {
		...
		launcherWeapon[] = {keko_W_TITAN_AA};
	};
	...
	class kekoMarksmanNato: kekoSoldierNato {
		name = "Marksman";
		vestInventory[] = {
[5, "#PRIMARY_MAG_MARKSMAN"],[1, "#SMOKE_WHITE"],[2, "#GRENADE"],[5, "#PRIMARY_MAG_MARKSMAN_TRACER"]
		};
		primary[] = {
			keko_W_A3_MXM, 
			keko_W_A3_MXM_BLACK};
	...
	class kekoSniperNato: kekoSoldierNato {
		...
		vestInventory[] = {
[1,"SmokeShell"],[1,"SmokeShellGreen"],[8,"ACE_7Rnd_408_305gr_Mag"],[2,"11Rnd_45ACP_Mag"]
		};
	...
	class kekoSpotterNato: kekoSniperNato {
		name = "Spotter";	
		vestInventory[] = {
[1,"SmokeShell"],[1,"SmokeShellGreen"],[2,"11Rnd_45ACP_Mag"],[10,"ACE_30Rnd_65x47_Scenar_mag"],[1,"HandGrenade"]
		};	
		primary[] = {
			keko_W_A3_MXM, 
			keko_W_A3_MXM_BLACK};
	...
	class kekoPilotNato: kekoSoldierLightNato {
		...
		vest[] = {"V_TacVest_blk"};
		vestInventory[] = {
[2, "#SECONDARY_MAG"],[1, "ACE_microDAGR"],[10, "ACE_quikclot"]
		};
	...
	class kekoUAVOperatorNato: kekoSoldierLightNato	{
		name = "UAV Operator";
		vestInventory[] = {
[2,"ACE_UAVBattery"],[2, "#PRIMARY_MAG"],[2, "#PRIMARY_MAG_TRACER"],[1,"ACE_HuntIR_monitor"],[8,"ACE_HuntIR_M203"]
		};
	};
};