class FactionUSBlackOpsTropic: FactionBase {
	...
	class backpackInventory: backpackInventory {
		...
		DoctorP90 = KEKO_LOADOUT_DOCTOR_DEFAULT_BACKPACK_INVENTORY;
		Medic = KEKO_LOADOUT_MEDIC_DEFAULT_BACKPACK_INVENTORY;
		MedicP90 = KEKO_LOADOUT_MEDIC_DEFAULT_BACKPACK_INVENTORY;
		RiflemanATGustav[] = { { 1, GUSTAV_MAG } };
		RiflemanATGustav416[] = { { 1, GUSTAV_MAG } };
		EOD = KEKO_LOADOUT_EOD_DEFAULT_BACKPACK_INVENTORY;
		EOD416 = KEKO_LOADOUT_EOD_DEFAULT_BACKPACK_INVENTORY;
		Engineer = KEKO_LOADOUT_ENGINEER_DEFAULT_BACKPACK_INVENTORY;
		Engineer416 = KEKO_LOADOUT_ENGINEER_DEFAULT_BACKPACK_INVENTORY;
