class kekoFactionRussiaEMRSummer: kekoFactionBase {
	...
	class kekoSoldierRussiaEMRSummer: kekoSoldier {
		uniform[] = {
	...
	class kekoSoldierLight: kekoSoldierRussiaEMRSummer {
		primary[] = {
			keko_W_AK74M_FOLDED};
	};

	class kekoLead: kekoSoldierRussiaEMRSummer	{
		name = "Lead";
		rank = "LIEUTENANT";
	...
	class kekoSQL: kekoSoldierRussiaEMRSummer	{
		name = "Squad Leader";
		rank = "SERGEANT";
		backpack[] = {"TFAR_rt1523g_green"};
		optics[] = {"Rangefinder"};
	...
	class kekoFTL: kekoSoldierRussiaEMRSummer	{
	...
	class kekoRifleman: kekoSoldierRussiaEMRSummer	{
		name = "Rifleman";
	};

	class kekoRiflemanAT: kekoSoldierRussiaEMRSummer	{
		name = "Rifleman Anti-Tank";
		launcher[] = {keko_W_RPG26};
	};

	class kekoGrenadier: kekoSoldierRussiaEMRSummer {
		name = "Grenadier";
		vestInventory[] = {
			{4, PRIMARY_MAG},
			{4, PRIMARY_MAG_TRACER},
	...
	class kekoLMG: kekoSoldierRussiaEMRSummer {
	...
	class kekoLMGAsst: kekoSoldierRussiaEMRSummer {
	...
	class kekoMMG: kekoSoldierRussiaEMRSummer {
	...
	class kekoMMGAsst: kekoSoldierRussiaEMRSummer {
	...
	class kekoATSpecialist: kekoSoldierRussiaEMRSummer {
	...
	class kekoATSpecialistAsst: kekoSoldierRussiaEMRSummer {
	...
	class kekoAASpecialistAsst: kekoSoldierRussiaEMRSummer {
	...
	class kekoMarksman: kekoSoldierRussiaEMRSummer {
		name = "Marksman";
		vestInventory[] = {
			{1, "ACE_RangeCard"},
	...
	class kekoSniper: kekoSoldierRussiaEMRSummer {
		name = "Sniper";
