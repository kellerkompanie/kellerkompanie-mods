class kekoFactionHAF: kekoFactionBase {
	...
	weaponCfg = kekoWeaponsHAF;

	// define all weapons and mags
	#include "kekoWeaponsHAF.hpp"
	...
	class kekoSoldierHAF: kekoSoldier {
		uniform[] = {
			"HEL_fat_1",
			"HEL_fat_2",
			"HEL_fat_3",
	...
	class kekoSoldierLight: kekoSoldierHAF {
		primary[] = {
			keko_W_A3_MXC};
	};

	class kekoLead: kekoSoldierHAF	{
		name = "Lead";
		rank = "LIEUTENANT";
		helmet[] = {"HEL_beret_1"};
	...
	class kekoRifleman: kekoSoldierHAF	{
		name = "Rifleman";
	};

	class kekoRiflemanAT: kekoSoldierHAF	{
		name = "Rifleman Anti-Tank";
		launcher[] = {keko_W_NLAW};
	};

	class kekoGrenadier: kekoSoldierHAF {
		name = "Grenadier";
		vestInventory[] = {
			{4, PRIMARY_MAG},
			{4, PRIMARY_MAG_TRACER},
	...
	class kekoMMGAsst: kekoSoldierHAF {
	...
	class kekoATSpecialist: kekoSoldierHAF {
	...
	class kekoATSpecialistAsst: kekoSoldierHAF {
	...
	class kekoAASpecialistAsst: kekoSoldierHAF {
	...
	class kekoMarksman: kekoSoldierHAF {
		name = "Marksman";
		vestInventory[] = {
			{1, "ACE_RangeCard"},
	...
	class kekoSniper: kekoSoldierHAF {
		name = "Sniper";
