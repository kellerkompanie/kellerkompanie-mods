class kekoFactionBundeswehrFleck: kekoFactionBase {
	...
	class kekoSoldierBundeswehrFleck: kekoSoldier {
		uniform[] = {
			"PBW_Uniform3_fleck",
			"PBW_Uniform4_fleck",
			"PBW_Uniform4K_fleck"};
	...
	class kekoSoldierLight: kekoSoldierBundeswehrFleck {

	};

	class kekoLead: kekoSoldierBundeswehrFleck	{
		name = "Zugführer";
		rank = "LIEUTENANT";
	...
	class kekoSQL: kekoSoldierBundeswehrFleck	{
		name = "Gruppenführer";
		rank = "SERGEANT";
		primary[] = {
			keko_W_G36_GL_HuntIR};
	...
	class kekoFTL: kekoSoldierBundeswehrFleck	{
		name = "Truppführer";
		rank = "CORPORAL";
		optics[] = {"Binocular"};
		vestInventory[] = {
	...
	class kekoRifleman: kekoSoldierBundeswehrFleck	{
		name = "Schütze";
	};

	class kekoRiflemanAT: kekoSoldierBundeswehrFleck	{
	...
	class kekoGrenadier: kekoSoldierBundeswehrFleck {
		name = "Grenadier";
		vestInventory[] = {
			{4, PRIMARY_MAG},
			{4, PRIMARY_MAG_TRACER},
	...
	class kekoLMG: kekoSoldierBundeswehrFleck {
		name = "Leichtes MG";
		vestInventory[] = {
			{4, PRIMARY_MAG_LMG},
			{1, SMOKE_WHITE},
	...
	class kekoLMGAsst: kekoSoldierBundeswehrFleck {
	...
	class kekoMMG: kekoSoldierBundeswehrFleck {
		name = "MMG Schütze";
		vestInventory[] = {
			{2, PRIMARY_MAG_MMG},
			{2, GRENADE}};
	...
	class kekoMMGAsst: kekoSoldierBundeswehrFleck {
		name = "MMG Helfer";
	...
	class kekoAASpecialistAsst: kekoSoldierBundeswehrFleck {
	...
	class kekoMarksman: kekoSoldierBundeswehrFleck {
	...
	class kekoSniper: kekoSoldierBundeswehrFleck {
		name = "Scharfschütze";
