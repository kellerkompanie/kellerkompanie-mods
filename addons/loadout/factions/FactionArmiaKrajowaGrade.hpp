class FactionArmiaKrajowaGrade: FactionBase {
	...
	class helmet: helmet {
		...
		SzeregowyThompson[] = { "H_LIB_POL_Cap" };
		SzeregowyBAR[] = { "H_LIB_POL_Cap_FgA1BR" };
		SzeregowyMosin[] = { "H_LIB_CIV_Villager_Cap_4", "H_LIB_POL_RA_OfficerCap_NoirA1" };
		SzeregowyK98[] = { "H_LIB_POL_Calot_BrunBR" };
	};
