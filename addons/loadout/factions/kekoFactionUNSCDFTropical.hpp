class kekoFactionUNSCDFTropical: kekoFactionBase {
	...
	class kekoSoldierUNSCDFTropical: kekoSoldier {
		uniform[] = {"OPTRE_UNSC_Army_Uniform_TRO"};
	...
	class kekoLead: kekoSoldierUNSCDFTropical	{
		name = "Lead";
		rank = "LIEUTENANT";
		uniform[] = {"OPTRE_UNSC_Army_Uniform_S_TRO"};
	...
	class kekoSQL: kekoSoldierUNSCDFTropical	{
		name = "Squad Leader";
		rank = "SERGEANT";
	...
	class kekoFTL: kekoSoldierUNSCDFTropical	{
	...
	class kekoDoctor: kekoSoldierUNSCDFTropical {
		name = "Doctor";
		medicClass = 2;
		rank = "SERGEANT";
	...
	class kekoMedic: kekoSoldierUNSCDFTropical {
		name = "Medic";
		medicClass = 1;
		rank = "CORPORAL";
		helmet[] = {"OPTRE_UNSC_CH252_Helmet2_WDL_MED"};
	...
	class kekoRifleman: kekoSoldierUNSCDFTropical	{
		name = "Rifleman";
	};

	class kekoRadioOperator: kekoSoldierUNSCDFTropical {
		name = "Radio Operator";
		backpack[] = {"OPTRE_ANPRC_521_Black"};
	};

	class kekoRiflemanAT: kekoSoldierUNSCDFTropical	{
	...
	class kekoGrenadier: kekoSoldierUNSCDFTropical {
		name = "Grenadier";
		vestInventory[] = {
			{4, PRIMARY_MAG},
			{4, PRIMARY_MAG_TRACER},
	...
	class kekoLMG: kekoSoldierUNSCDFTropical {
	...
	class kekoLMGAsst: kekoSoldierUNSCDFTropical {
	...
	class kekoATSpecialist: kekoSoldierUNSCDFTropical {
	...
	class kekoATSpecialistAsst: kekoSoldierUNSCDFTropical {
	...
	class kekoAASpecialist: kekoSoldierUNSCDFTropical {
	...
	class kekoAASpecialistAsst: kekoSoldierUNSCDFTropical {
	...
	class kekoMarksman: kekoSoldierUNSCDFTropical {
		name = "Marksman";
		vestInventory[] = {
			{1, "ACE_RangeCard"},
	...
	class kekoEOD: kekoSoldierUNSCDFTropical {
	...
	class kekoEngineer: kekoSoldierUNSCDFTropical {
		name = "Engineer";
		backpack[] = {"OPTRE_UNSC_Rucksack_Heavy"};
	...
	class kekoDriver: kekoSoldierUNSCDFTropical {
		name = "Crewman";
	...
	class kekoUAVOperator: kekoSoldierUNSCDFTropical	{
		name = "UAV Operator";
		vestInventory[] = {
			{2,"ACE_UAVBattery"},
			{2,PRIMARY_MAG},
