class GVAR(Dynamic_Dialog)
{
    ...
    class controls
    {
        ...
        class GVAR(Content): RscControlsGroup
        {
            idc = 7000;
            x = 0 * GUI_GRID_W + GUI_GRID_X;
        ...
        {
            onButtonClick = "uiNamespace setVariable ['keko_zeus_ChooseDialog_Result', 1]; closeDialog 1;";
            idc = 3000;
        ...
        {
            onButtonClick = "uiNamespace setVariable ['keko_zeus_ChooseDialog_Result', -1]; closeDialog 2;";
            idc = 3010;
