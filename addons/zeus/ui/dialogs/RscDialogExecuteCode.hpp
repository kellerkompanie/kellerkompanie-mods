class GVAR(ExecuteCode_Dialog)
{
    idd = 123;
    movingEnable = true;
    onLoad = "((_this select 0) displayCtrl 1400) ctrlSetText (profileNamespace getVariable ['keko_zeus_ExecuteCode_Dialog_Text', '']);";
    onUnload = "profileNamespace setVariable ['keko_zeus_ExecuteCode_Dialog_Text', ctrlText ((_this select 0) displayCtrl 1400)];";
    ...
    class controls
    {
        ...
        class GVAR(Title): RscText
        {
            ...
            text = "$STR_keko_zeus_EXECUTE_CODE"; //--- ToDo: Localize;
        ...
        {
            onButtonClick = "uiNamespace setVariable ['keko_zeus_ExecuteCode_Dialog_Result', 1]; closeDialog 1;";
            idc = 3000;
        ...
        {
            onButtonClick = "uiNamespace setVariable ['keko_zeus_ExecuteCode_Dialog_Result', -1]; closeDialog 2;";
            idc = 3010;
        ...
        class GVAR(Dialog_Paragraph_Combo): RscText
        {
            idc = 1010;
        ...
        class GVAR(Dialog_Combo): RscCombo
        {
            onLBSelChanged = "uiNamespace setVariable ['keko_zeus_ExecuteCode_Dialog_Constraint', _this select 1];";
            idc = 4000;
        ...
        class GVAR(Paragraph_edit): RscText
        {
            ...
            text = "$STR_keko_zeus_WRITE_OR_PASTE_CODE"; //--- ToDo: Localize;
