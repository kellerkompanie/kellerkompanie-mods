...
#include "\x\keko\addons\zeus\ui\dialogs\defineResGrids.inc.sqf"
...
switch _mode do
{
    case "onLoad":
    {
        ...
        private _enableCodeExecution = ((missionNamespace getVariable [QGVAR(Allow_Zeus_To_Execute_Code), true]) or ((call BIS_fnc_admin) > 0));
        ...
        private _posH = ((_posY + _ctrlContentOffsetY) min (0.746 * safeZoneH)) * 0.5;
