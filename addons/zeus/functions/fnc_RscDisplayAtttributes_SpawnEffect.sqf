...
switch (_mode) do
{
    case "LOADED":
    {
        ...
        [0,_category_ctrl,_last_choice] call FUNC(RscDisplayAtttributes_SpawnEffect);
    };
    case "0":
    {
        ...
        } else
        {
            ...
            _classNames = (configfile >> "CfgVehicles" >> _module_category) call FUNC(ClassNamesWhichInheritsFromCfgClass);
