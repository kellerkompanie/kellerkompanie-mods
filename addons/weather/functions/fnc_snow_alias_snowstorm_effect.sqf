...
[] spawn {
    while {al_snowstorm_om} do {
        ...
        private _tremurici = ["tremurat_1","tremurat_2","NoSound","tremurat_3","tremurat_4","rafala_8"] call BIS_fnc_selectRandom;
...
while {al_snowstorm_om} do {
    ...
    private _fulg_nea  = "#particlesource" createVehicle [getposasl hunt_alias select 0,getposasl hunt_alias select 1,(getposasl hunt_alias select 2)+10];
    ...
    private _alias_local_fog = "#particlesource" createVehicleLocal (getpos vehicle player);
