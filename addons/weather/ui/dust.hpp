class dust_menu{
    ...
    class Controls
    {
        ...
        {
            idc = 2100;
            x = QUOTE(0.422656 * safezoneW + safezoneX);
        ...
        class s_b_intensity: RscSlider
        {
            idc = 1903;
            x = QUOTE(0.443281 * safezoneW + safezoneX);
            y = QUOTE(0.632 * safezoneH + safezoneY);
            w = QUOTE(0.185625 * safezoneW);
            h = QUOTE(0.022 * safezoneH);
    ...
    class controlsBackground
    {
        ...
        class t_header_bg: RscText
        {
            ...
            x = QUOTE(0.417499 * safezoneW + safezoneX);
        ...
        class t_wall: RscText
        {
            ...
            x = QUOTE(0.510312 * safezoneW + safezoneX);
            y = QUOTE(0.324 * safezoneH + safezoneY);
            w = QUOTE(0.12375 * safezoneW);
            h = QUOTE(0.044 * safezoneH);
        };
        class t_objects: RscText
        {
            ...
            x = QUOTE(0.29375 * safezoneW + safezoneX);
            y = QUOTE(0.379 * safezoneH + safezoneY);
            w = QUOTE(0.12375 * safezoneW);
            h = QUOTE(0.044 * safezoneH);
        };
        ...
        class t_direction: RscText
        {
            ...
            y = QUOTE(0.445 * safezoneH + safezoneY);
        ...
        class t_d_intensity: RscText
        {
            ...
            x = QUOTE(0.335 * safezoneW + safezoneX);
            y = QUOTE(0.665 * safezoneH + safezoneY);
            w = QUOTE(0.0979687 * safezoneW);
            h = QUOTE(0.044 * safezoneH);
        };
