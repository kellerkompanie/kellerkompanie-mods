...
/*
 * Author: Glowbal - modified by Belbo - modified by Schwaggot
...
if ((_tourniquets select _part) == 0) exitWith {
    ["ace_common_displayTextStructured", [localize LSTRING(noTourniquetOnBodyPart), 1.5, _caller], [_caller]] call CBA_fnc_targetEvent;
};
