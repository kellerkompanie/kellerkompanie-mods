class MainSubmenu: cTab_RscControlsGroup
{
	...
	class controls
	{
		...
		class op4btn: cTab_MenuItem
		{
			...
			h = MENU_elementH;
			sizeEx = MENU_sizeEx;
			action = "[11] call keko_ctab_fnc_userMenuSelect;";
		};
		class medbtn: cTab_MenuItem
		{
			...
			h = MENU_elementH;
			sizeEx = MENU_sizeEx;
			action = "[21] call keko_ctab_fnc_userMenuSelect;";
		};
		class genbtn: cTab_MenuItem
		{
			...
			h = MENU_elementH;
			sizeEx = MENU_sizeEx;
			action = "[31] call keko_ctab_fnc_userMenuSelect;";
		};
			...
			class lockUavCam: cTab_MenuItem
			{
				...
				h = MENU_elementH;
				sizeEx = MENU_sizeEx;
				action = "[2] call keko_ctab_fnc_userMenuSelect;";
			};
		#endif
		class exit: cTab_MenuExit
		{
			...
			h = MENU_elementH;
			sizeEx = MENU_sizeEx;
			action = "[0] call keko_ctab_fnc_userMenuSelect;";
		};
	};
};
...
class EnemySub1: cTab_RscControlsGroup
{
	...
	class controls
	{
		...
		class infbtn: cTab_MenuItem
		{
			...
			h = MENU_elementH;
			sizeEx = MENU_sizeEx;
			action = "cTabUserSelIcon set [1,0];[12] call keko_ctab_fnc_userMenuSelect;";
		};
		class mecinfbtn: cTab_MenuItem
		{
			...
			h = MENU_elementH;
			sizeEx = MENU_sizeEx;
			action = "cTabUserSelIcon set [1,1];[12] call keko_ctab_fnc_userMenuSelect;";
		};
		...
		class motrinfbtn: cTab_MenuItem
		{
			...
			h = MENU_elementH;
			sizeEx = MENU_sizeEx;
			action = "cTabUserSelIcon set [1,2];[12] call keko_ctab_fnc_userMenuSelect;";
		};
		class amrbtn: cTab_MenuItem
		{
			...
			h = MENU_elementH;
			sizeEx = MENU_sizeEx;
			action = "cTabUserSelIcon set [1,3];[12] call keko_ctab_fnc_userMenuSelect;";
		};
		class helibtn: cTab_MenuItem
		{
			...
			h = MENU_elementH;
			sizeEx = MENU_sizeEx;
			action = "cTabUserSelIcon set [1,4];[12] call keko_ctab_fnc_userMenuSelect;";
		};
		class plnbtn: cTab_MenuItem
		{
			...
			h = MENU_elementH;
			sizeEx = MENU_sizeEx;
			action = "cTabUserSelIcon set [1,5];[12] call keko_ctab_fnc_userMenuSelect;";
		};
		class uknbtn: cTab_MenuItem
		{
			...
			h = MENU_elementH;
			sizeEx = MENU_sizeEx;
			action = "cTabUserSelIcon set [1,6];[12] call keko_ctab_fnc_userMenuSelect;";
		};
		class exit: cTab_MenuExit
		{
			idc = -1;
...
class EnemySub2: cTab_RscControlsGroup
{
	...
	class controls
	{
		...
		class ftbtn: cTab_MenuItem
		{
			...
			h = MENU_elementH;
			sizeEx = MENU_sizeEx;
			action = "[14] call keko_ctab_fnc_userMenuSelect;";
		};
		class patbtn: cTab_MenuItem
		{
			...
			h = MENU_elementH;
			sizeEx = MENU_sizeEx;
			action = "cTabUserSelIcon set [2,1];[13] call keko_ctab_fnc_userMenuSelect;";
		};
		class sqdbtn: cTab_MenuItem
		{
			...
			h = MENU_elementH;
			sizeEx = MENU_sizeEx;
			action = "cTabUserSelIcon set [2,2];[13] call keko_ctab_fnc_userMenuSelect;";
		};
		class sctbtn: cTab_MenuItem
		{
			...
			h = MENU_elementH;
			sizeEx = MENU_sizeEx;
			action = "cTabUserSelIcon set [2,3];[13] call keko_ctab_fnc_userMenuSelect;";
		};
		class pltnbtn: cTab_MenuItem
		{
			...
			h = MENU_elementH;
			sizeEx = MENU_sizeEx;
			action = "cTabUserSelIcon set [2,4];[13] call keko_ctab_fnc_userMenuSelect;";
		};
		class exit: cTab_MenuExit
		{
			idc = -1;
...
class EnemySub3: cTab_RscControlsGroup
{
	...
	class controls
	{
		...
		class stnbtn: cTab_MenuItem
		{
			...
			h = MENU_elementH;
			sizeEx = MENU_sizeEx;
			action = "[1] call keko_ctab_fnc_userMenuSelect;";
		};
		class nthbtn: cTab_MenuItem
		{
			...
			h = MENU_elementH;
			sizeEx = MENU_sizeEx;
			action = "cTabUserSelIcon set [3,1];[1] call keko_ctab_fnc_userMenuSelect;";
		};
		class nebtn: cTab_MenuItem
		{
			...
			h = MENU_elementH;
			sizeEx = MENU_sizeEx;
			action = "cTabUserSelIcon set [3,2];[1] call keko_ctab_fnc_userMenuSelect;";
		};
		class ebtn: cTab_MenuItem
		{
			...
			h = MENU_elementH;
			sizeEx = MENU_sizeEx;
			action = "cTabUserSelIcon set [3,3];[1] call keko_ctab_fnc_userMenuSelect;";
		};
		class sebtn: cTab_MenuItem
		{
			...
			h = MENU_elementH;
			sizeEx = MENU_sizeEx;
			action = "cTabUserSelIcon set [3,4];[1] call keko_ctab_fnc_userMenuSelect;";
		};
		class sbtn: cTab_MenuItem
		{
			...
			h = MENU_elementH;
			sizeEx = MENU_sizeEx;
			action = "cTabUserSelIcon set [3,5];[1] call keko_ctab_fnc_userMenuSelect;";
		};
		class swbtn: cTab_MenuItem
		{
			...
			h = MENU_elementH;
			sizeEx = MENU_sizeEx;
			action = "cTabUserSelIcon set [3,6];[1] call keko_ctab_fnc_userMenuSelect;";
		};
		class wbtn: cTab_MenuItem
		{
			...
			h = MENU_elementH;
			sizeEx = MENU_sizeEx;
			action = "cTabUserSelIcon set [3,7];[1] call keko_ctab_fnc_userMenuSelect;";
		};
		class RscText_1022: cTab_MenuItem
		{
			...
			h = MENU_elementH;
			sizeEx = MENU_sizeEx;
			action = "cTabUserSelIcon set [3,8];[1] call keko_ctab_fnc_userMenuSelect;";
		};
		class exit: cTab_MenuExit
		{
			idc = -1;
...
class EnemySub4: cTab_RscControlsGroup
{
	...
	class controls
	{
		...
		class rifle_btn: cTab_MenuItem
		{
			...
			h = MENU_elementH;
			sizeEx = MENU_sizeEx;
			action = "cTabUserSelIcon set [1,7];[13] call keko_ctab_fnc_userMenuSelect;";
		};
		class lmg_btn: cTab_MenuItem
		{
			...
			h = MENU_elementH;
			sizeEx = MENU_sizeEx;
			action = "cTabUserSelIcon set [1,8];[13] call keko_ctab_fnc_userMenuSelect;";
		};
		class at_btn: cTab_MenuItem
		{
			...
			h = MENU_elementH;
			sizeEx = MENU_sizeEx;
			action = "cTabUserSelIcon set [1,9];[13] call keko_ctab_fnc_userMenuSelect;";
		};
		class mmg_btn: cTab_MenuItem
		{
			...
			h = MENU_elementH;
			sizeEx = MENU_sizeEx;
			action = "cTabUserSelIcon set [1,10];[13] call keko_ctab_fnc_userMenuSelect;";
		};
		class mat_btn: cTab_MenuItem
		{
			...
			h = MENU_elementH;
			sizeEx = MENU_sizeEx;
			action = "cTabUserSelIcon set [1,11];[13] call keko_ctab_fnc_userMenuSelect;";
		};
		class aa_btn: cTab_MenuItem
		{
			...
			h = MENU_elementH;
			sizeEx = MENU_sizeEx;
			action = "cTabUserSelIcon set [1,13];[13] call keko_ctab_fnc_userMenuSelect;";
		};
		class mmortar_btn: cTab_MenuItem
		{
			...
			h = MENU_elementH;
			sizeEx = MENU_sizeEx;
			action = "cTabUserSelIcon set [1,12];[13] call keko_ctab_fnc_userMenuSelect;";
		};
		class exit: cTab_MenuExit
		{
			idc = -1;
...
class CasulSub1: cTab_RscControlsGroup
{
	...
	class controls
	{
		...
		class casltybtn: cTab_MenuItem
		{
			...
			h = MENU_elementH;
			sizeEx = MENU_sizeEx;
			action = "cTabUserSelIcon set [1,20];[1] call keko_ctab_fnc_userMenuSelect;";
		};
		class ccpbtn: cTab_MenuItem
		{
			...
			h = MENU_elementH;
			sizeEx = MENU_sizeEx;
			action = "cTabUserSelIcon set [1,21];[1] call keko_ctab_fnc_userMenuSelect;";
		};
		class basbtn: cTab_MenuItem
		{
			...
			h = MENU_elementH;
			sizeEx = MENU_sizeEx;
			action = "cTabUserSelIcon set [1,22];[1] call keko_ctab_fnc_userMenuSelect;";
		};
		...
		class mcibtn: cTab_MenuItem
		{
			...
			h = MENU_elementH;
			sizeEx = MENU_sizeEx;
			action = "cTabUserSelIcon set [1,23];[1] call keko_ctab_fnc_userMenuSelect;";
		};
		class exit: cTab_MenuExit
		{
			idc = -1;
...
class GenSub1: cTab_RscControlsGroup
{
	...
	class controls
	{
		...
		class hqbtn: cTab_MenuItem
		{
			...
			h = MENU_elementH;
			sizeEx = MENU_sizeEx;
			action = "cTabUserSelIcon set [1,30];[1] call keko_ctab_fnc_userMenuSelect;";
		};
		class lzbtn: cTab_MenuItem
		{
			...
			h = MENU_elementH;
			sizeEx = MENU_sizeEx;
			action = "cTabUserSelIcon set [1,31];[1] call keko_ctab_fnc_userMenuSelect;";
		};
		class exit: cTab_MenuExit
		{
			idc = -1;
