		...
		class menuContainer: cTab_RscControlsGroup
		{
			...
			class controls
			{
				...
				class btnF5: btnTextonoff
				{
					...
					action = "['cTab_Android_dlg'] call keko_ctab_fnc_toggleMapTools;";
				};
				...
				class btnF7: btnTextonoff
				{
					...
					text = "Center Map";
					action = "['cTab_Android_dlg'] call keko_ctab_fnc_centerMapOnPlayerPosition;";
		...
		class MESSAGE: cTab_RscControlsGroup
		{
			...
			class controls
			{
				...
				class toCompose: cTab_RscButton
				{
					...
					w = pxToScreen_W(cTab_GUI_android_MESSAGE_BUTTON_W);
					h = pxToScreen_H(cTab_GUI_android_MESSAGE_BUTTON_H);
					action = "['cTab_Android_dlg',[['mode','COMPOSE']]] call keko_ctab_fnc_setSettings;";
				};
			};
		};
		// ---------- MESSAGING COMPOSE -----------
		class COMPOSE: cTab_RscControlsGroup
		{
			...
			class controls
			{
				...
				class toRead: cTab_RscButton
				{
					...
					w = pxToScreen_W(cTab_GUI_android_MESSAGE_BUTTON_W);
					h = pxToScreen_H(cTab_GUI_android_MESSAGE_BUTTON_H);
					action = "['cTab_Android_dlg',[['mode','MESSAGE']]] call keko_ctab_fnc_setSettings;";
				};
			};
		};
