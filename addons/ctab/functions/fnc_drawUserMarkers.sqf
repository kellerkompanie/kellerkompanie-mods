/*
	Name: keko_ctab_fnc_drawUserMarkers
	...
	Example:
		[_ctrlScreen] call keko_ctab_fnc_drawUserMarkers;
*/
...
_cursorMarkerIndex = if (_this select 1) then {[_ctrlScreen,cTabMapCursorPos] call FUNC(findUserMarker)} else {-1};
{
