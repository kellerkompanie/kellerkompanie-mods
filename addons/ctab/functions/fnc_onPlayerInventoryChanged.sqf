/*
	Name: keko_ctab_fnc_onPlayerInventoryChanged
	...
	Example:
		[ACE_player,[player] call ace_common_fnc_getAllGear] call keko_ctab_fnc_onPlayerInventoryChanged;
*/
...
if (_playerLostDevice) then {[] call FUNC(close)};
