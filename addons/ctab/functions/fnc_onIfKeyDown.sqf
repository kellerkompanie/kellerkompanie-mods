/*
 	Name: keko_ctab_fnc_onIfKeyDown
	...
	Parameters:
 	...
 	Example:
		[_display,_dikCode,_shiftKey,_ctrlKey,_altKey] call keko_ctab_fnc_onIfKeyDown;
*/
...
if (_dikCode == DIK_DELETE && {cTabCursorOnMap}) exitWith {
	...
	_markerIndex = [_ctrlScreen,cTabMapCursorPos] call FUNC(findUserMarker);
