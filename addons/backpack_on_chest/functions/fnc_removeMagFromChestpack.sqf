 ...
 * If you want to remove a magazine with just any amount of ammo you may want to use 'keko_backpack_on_chest_fnc_removeItemFromChestpack' instead.
 *
 * Arguments:
 * 0: Unit <OBJECT>
 * 1: Classname <STRING>
 ...
 *
 * Example:
 * [player,"30Rnd_556x45_Stanag",25] call keko_backpack_on_chest_fnc_removeMagFromChestpack;
 *
 * Public: No
 */
