...
private _action = [QGVAR(backpackLockAction), localize LSTRING(actionLock),QPATHTOF(ui\icon_lock_closed.paa),{
...
_action = [QGVAR(backpackUnlockAction), localize LSTRING(actionUnlock),QPATHTOF(ui\icon_lock_open.paa),{
