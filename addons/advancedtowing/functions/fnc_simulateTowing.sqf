...
private ["_newCargoDir","_lastCargoVectorDir","_newCargoPosition","_doExit","_cargoPosition","_maxVehicleSpeed","_vehicleMass","_cargoMass","_cargoCanFloat"];
private ["_cargoCorner1ASL","_cargoCorner2ASL","_cargoCorner3ASL","_cargoCorner4ASL","_surfaceNormal1","_surfaceNormal2","_surfaceNormal"];
...
private _towingSpeedSimulationHandle = [_vehicle] spawn FUNC(simulateTowingSpeed);
