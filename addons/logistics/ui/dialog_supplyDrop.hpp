class keko_logistics_supplyDropDialog {

	idd = 11;
	movingEnable = true;
	enableSimulation = true;
	
	onload = "(_this) spawn keko_logistics_fnc_dialogSupplyDropInit;";
	...
	class KEKO_LOGISTICS_UI_BUTTON_OK: RscButton
	{
		...
		w = 9 * GUI_GRID_W;
		h = 1.5 * GUI_GRID_H;
		action = "lbData [1500, lbCurSel 1500] spawn keko_logistics_fnc_dialogSupplyDropCallback;";
	};
