class dust_menu{
	idd = 1000;
	movingEnable = 1;
	onLoad = "[] spawn keko_weather_fnc_dust_menuOnload;";
	class Controls
	{
		...
		class s_direction: RscSlider
		{
			...
			h = 0.022 * safezoneH;
			onSliderPosChanged = "sliderNr = 0; [] spawn keko_weather_fnc_dust_setSliderValue; false";
		};
		class s_duration: RscSlider
		{
			...
			w = 0.185625 * safezoneW;
			h = 0.022 * safezoneH;
			onSliderPosChanged = "sliderNr = 1; [] spawn keko_weather_fnc_dust_setSliderValue; false";
		};
		class s_delay: RscSlider
		{
			...
			w = 0.185625 * safezoneW;
			h = 0.022 * safezoneH;
			onSliderPosChanged = "sliderNr = 2; [] spawn keko_weather_fnc_dust_setSliderValue; false";
		};
		class s_b_intensity: RscSlider
		{
			...
			w = 0.185625 * safezoneW;
			h = 0.022 * safezoneH;
			onSliderPosChanged = "sliderNr = 3; [] spawn keko_weather_fnc_dust_setSliderValue; false";
		};
		class s_d_intensity: RscSlider
		{
			...
			w = 0.185625 * safezoneW;
			h = 0.022 * safezoneH;
			onSliderPosChanged = "sliderNr = 4; [] spawn keko_weather_fnc_dust_setSliderValue; false";
		};
		class b_close
		{
			idc = 1600;
		...
		class b_confirm
		{
			...
			tooltipColorText[] = {1,1,1,1}; // Tooltip text color
			tooltipColorBox[] = {0.15,0.25,0.55,1}; // Tooltip frame color
			action = "[] spawn keko_weather_fnc_dust_storm_init; false";
		};
		class b_abort
		{
			idc = 1602;
			...
			tooltipColorText[] = {1,1,1,1}; // Tooltip text color
			tooltipColorBox[] = {0.15,0.25,0.55,1}; // Tooltip frame color
			action = "[] spawn keko_weather_fnc_dust_abortStorm; false";
		};
	};
	class controlsBackground
	{
		...
		{
			idc = 1000;
			text = "keko_weather\images\tablet.paa";
			colorText[] = {1, 1, 1, 1};
