...
[[keko_weather_fnc_dust_alias_duststorm_effect],"BIS_fnc_spawn",true,true,false] call BIS_fnc_MP;

if (_dust_wall) then {//																										<-- DUST WALL CODE
	// perete de praf (dust wall)
	//_rand_pl = [] execVM "AL_dust_storm\alias_hunt.sqf";
	_rand_pl = [] spawn keko_weather_fnc_dust_alias_hunt;
	...
	_stormsource = "Land_HelipadEmpty_F" createVehicle _pozobcj;//																<-- Create dust wall on pos "_pozobcj"
...
// >>>>>>>>>>>>>>>>>>>>
	...
	[[[_stormsource,_duration_duststorm],keko_weather_fnc_dust_alias_dust_wall],"BIS_fnc_spawn",true,true,false] call BIS_fnc_MP;
	sleep 0.1;
	//[[_stormsource_1,_duration_duststorm],"AL_dust_storm\alias_dust_wall.sqf"] remoteExec ["BIS_fnc_execVM"];

	[[[_stormsource_1,_duration_duststorm],keko_weather_fnc_dust_alias_dust_wall],"BIS_fnc_spawn",true,true,false] call BIS_fnc_MP;
	sleep 0.1;
	//[[_stormsource_2,_duration_duststorm],"AL_dust_storm\alias_dust_wall.sqf"] remoteExec ["BIS_fnc_execVM"];

	[[[_stormsource_2,_duration_duststorm],keko_weather_fnc_dust_alias_dust_wall],"BIS_fnc_spawn",true,true,false] call BIS_fnc_MP;
	sleep 0.1;
	//[[_stormsource_3,_duration_duststorm],"AL_dust_storm\alias_dust_wall.sqf"] remoteExec ["BIS_fnc_execVM"];

	[[[_stormsource_3,_duration_duststorm],keko_weather_fnc_dust_alias_dust_wall],"BIS_fnc_spawn",true,true,false] call BIS_fnc_MP;
	sleep 0.1;
	//[[_stormsource_4,_duration_duststorm],"AL_dust_storm\alias_dust_wall.sqf"] remoteExec ["BIS_fnc_execVM"];

	[[[_stormsource_4,_duration_duststorm],keko_weather_fnc_dust_alias_dust_wall],"BIS_fnc_spawn",true,true,false] call BIS_fnc_MP;
	sleep 0.1;
	//[[_stormsource_5,_duration_duststorm],"AL_dust_storm\alias_dust_wall.sqf"] remoteExec ["BIS_fnc_execVM"];

	[[[_stormsource_5,_duration_duststorm],keko_weather_fnc_dust_alias_dust_wall],"BIS_fnc_spawn",true,true,false] call BIS_fnc_MP;
	sleep 0.1;
	//[[_stormsource_6,_duration_duststorm],"AL_dust_storm\alias_dust_wall.sqf"] remoteExec ["BIS_fnc_execVM"];

	[[[_stormsource_6,_duration_duststorm],keko_weather_fnc_dust_alias_dust_wall],"BIS_fnc_spawn",true,true,false] call BIS_fnc_MP;
};
...
if (_effect_on_objects) then {//																								<-- EFFECT ON OBJECTS CODE
	...
	// interval object blow
		...
		sleep 1;
		[] spawn {
			_rafale = ["rafala_1","sandstorm","rafala_4_dr","rafala_5_st"] call BIS_fnc_selectRandom;//							<-- Execution of sound files
...
[] spawn {
	while {al_duststorm_on} do {
		_rafale = ["rafala_1","sandstorm","rafala_4_dr","rafala_5_st"] call BIS_fnc_selectRandom;//									<-- ADDED: Opportunity to customize ambient sound delay
		[_rafale] remoteExec ["playSound"];
