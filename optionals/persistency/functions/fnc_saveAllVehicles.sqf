...
if !(EGVAR(persistency_settings,vehiclesEnabled)) exitWith{diag_log text "[KEKO] (persistency) saveAllVehicles: persistency for vehicles is disabled, exiting!"; false};
