// Player gets PINGED by - General (older tech) --- Type 1
//
if (VQI_FROGS_HINTS == 1) then { hint "sub_class_1_trg_sonar.sqf"; };
sleep 3;
...
// Operating Depth
if (VQI_FROGS_HINTS == 1) then { hint format ["Starting Operating Depth: %1",_subDepth]; sleep 3; hint "- Pinged by CLASS 1 - \n \n Type 1 \n Attack"; };
sleep 3;
...
// QRF Call for Help/Investigate - 30%
...
sleep 1;
if (VQI_FROGS_HINTS == 1) then { hint "sub_class_1_trg_sonar.sqf -END-"; };
