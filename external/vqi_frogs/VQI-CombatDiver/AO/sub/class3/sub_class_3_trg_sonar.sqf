// Player gets PINGED by - Hunter Killer --- Kraken
//
if (VQI_FROGS_HINTS == 1) then { hint "sub_class_3_trg_sonar.sqf"; };
sleep 1;
...
// Operating Depth
if (VQI_FROGS_HINTS == 1) then { hint format ["Starting Operating Depth: %1",_subDepth]; sleep 3; hint "- Pinged by CLASS 3 - \n \n Kraken \n Attack"; };
sleep 3;
...
_oDivers = nearestObjects [player, ["O_Diver_F"], 4000];
...
sleep 1;
if (VQI_FROGS_HINTS == 1) then { hint "sub_class_3_trg_sonar.sqf -END-"; };
