// Player gets PINGED by - General (newer tech) --- Crimson II
//
if (VQI_FROGS_HINTS == 1) then { hint "sub_class_2_trg_sonar.sqf"; };
sleep 1;
...
// Operating Depth
if (VQI_FROGS_HINTS == 1) then { hint format ["Starting Operating Depth: %1",_subDepth]; sleep 3; hint "- Pinged by CLASS 2 - \n \n Crimson II \n Attack"; };
sleep 3;
...
// QRF Call for Help/Investigate - 60%
...
sleep 1;
if (VQI_FROGS_HINTS == 1) then { hint "sub_class_2_trg_sonar.sqf -END-"; };
