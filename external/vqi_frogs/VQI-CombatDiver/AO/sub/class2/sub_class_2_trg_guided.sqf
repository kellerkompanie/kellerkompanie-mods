// Guided Missile Submarine Strike --- Crimson II
//
if (VQI_FROGS_HINTS == 1) then { hint "sub_class_2_trg_guided.sqf"; };
sleep 1;
...
sleep 1;
if (VQI_FROGS_HINTS == 1) then { hint "sub_class_2_trg_guided.sqf -END-"; };
