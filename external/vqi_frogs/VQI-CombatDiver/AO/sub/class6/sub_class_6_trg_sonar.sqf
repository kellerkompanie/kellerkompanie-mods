// Player gets PINGED by - Surrveilence Submarine --- Djinn
//
if (VQI_FROGS_HINTS == 1) then { hint "sub_class_6_trg_sonar.sqf"; };
sleep 1;
...
// Operating Depth
if (VQI_FROGS_HINTS == 1) then { hint format ["Starting Operating Depth: %1",_subDepth]; sleep 3; hint "- Pinged by CLASS 6 - \n \n Djinn \n Intel Submarine"; };
sleep 3;
...
_oDivers = nearestObjects [player, ["O_Diver_F"], 7000];
...
sleep 1;
if (VQI_FROGS_HINTS == 1) then { hint "sub_class_6_trg_sonar.sqf -END-"; };
