...
[[[_IntSnowWindDir, _IntSnowDuration, BoolEffectOnObjects, _IntAmbientSoundDelay, BoolBreath, BoolSnowBurstServer, BoolSnowBurstClient, BoolChangeFog, BoolHoverUnit],keko_weather_fnc_snow_al_snow],'BIS_fnc_spawn',true,true,false] call BIS_fnc_MP;
