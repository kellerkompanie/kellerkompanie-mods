...
_desertVegetation_I = lbCurSel 2100;
_Wall_I = lbCurSel 2101;
_EffectOnObjects_I = lbCurSel 2102;
_lethalWall_I = lbCurSel 2103;


_IntDustWindDir = sliderposition 1900;
_IntDustDuration = sliderposition 1901;
_IntAmbientSoundDelay = sliderposition 1902;
_leaves_p_drop_I = sliderposition 1903;
_alias_drop_fog_factor_I = sliderposition 1904;
...
[[[_IntDustWindDir, _IntDustDuration, BoolEffectOnObjects, BoolWall, BoolLethalWall, _IntAmbientSoundDelay, BoolHoverUnit],keko_weather_fnc_dust_al_duststorm],"BIS_fnc_spawn",true,true,false] call BIS_fnc_MP;
