class snow_menu{
	idd = 1000;
	movingEnable = 1;
	onLoad = "[] spawn keko_weather_fnc_snow_menuOnload;";
	class Controls
	{
		class c_objects
		{
		...
		class s_direction
		{
			...
			h = 0.022 * safezoneH;
			onSliderPosChanged = "sliderNr = 0; [] spawn keko_weather_fnc_snow_setSliderValue; false";
			default = 0; // Control selected by default (only one within a display can be used)
			blinkingPeriod = 0; // Time in which control will fade out and back in. Use 0 to disable the effect.
		...
		class s_duration
		{
			...
			w = 0.185625 * safezoneW;
			h = 0.022 * safezoneH;
			onSliderPosChanged = "sliderNr = 1; [] spawn keko_weather_fnc_snow_setSliderValue; false";
			default = 0; // Control selected by default (only one within a display can be used)
			blinkingPeriod = 0; // Time in which control will fade out and back in. Use 0 to disable the effect.
			color[] = {1,1,1,1}; // Text and arrow color
			colorDisabled[] = {1,1,1,0.5}; // Disabled text and arrow color
		...
		class s_delay
		{
			...
			w = 0.185625 * safezoneW;
			h = 0.022 * safezoneH;
			onSliderPosChanged = "sliderNr = 2; [] spawn keko_weather_fnc_snow_setSliderValue; false";
			default = 0; // Control selected by default (only one within a display can be used)
			blinkingPeriod = 0; // Time in which control will fade out and back in. Use 0 to disable the effect.
			color[] = {1,1,1,1}; // Text and arrow color
			colorDisabled[] = {1,1,1,0.5}; // Disabled text and arrow color
		...
		class s_intensity
		{
			...
			w = 0.185625 * safezoneW;
			h = 0.022 * safezoneH;
			onSliderPosChanged = "sliderNr = 3; [] spawn keko_weather_fnc_snow_setSliderValue; false";
			default = 0; // Control selected by default (only one within a display can be used)
			blinkingPeriod = 0; // Time in which control will fade out and back in. Use 0 to disable the effect.
			color[] = {1,1,1,1}; // Text and arrow color
			colorDisabled[] = {1,1,1,0.5}; // Disabled text and arrow color
		...
		class b_confirm
		{
			...
			tooltipColorText[] = {1,1,1,1}; // Tooltip text color
			tooltipColorBox[] = {0.15,0.25,0.55,1}; // Tooltip frame color
			action = "[] spawn keko_weather_fnc_snow_storm_init; false";
		};
		class b_abort
		{
			idc = 1602;
			...
			tooltipColorText[] = {1,1,1,1}; // Tooltip text color
			tooltipColorBox[] = {0.15,0.25,0.55,1}; // Tooltip frame color
			action = "[] spawn keko_weather_fnc_snow_terminateSnow; false";
		};
	};
