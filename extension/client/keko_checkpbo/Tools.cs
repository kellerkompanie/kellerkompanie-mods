...
namespace keko_checkpbo
{
    internal class Tools
    {
        ...
        private static readonly string ExtFilePath = Path.Combine(AssemblyPath, "keko_checkpbo");
        private static readonly string LogFilePath = Path.Combine(ExtFilePath, "logs");
        private static readonly string LogFileName = Path.Combine(LogFilePath, $"{DateTime.Now.ToString("yyyy-MM-dd.HH-mm-ss")}.keko_checkpbo.log");
